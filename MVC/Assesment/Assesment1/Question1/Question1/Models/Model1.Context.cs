...
namespace Question1.Models
{
    ...
    public partial class northwindEntities : DbContext
    {
        ...
        public virtual IQueryable<fn_getcustomersbycountry_Result> fn_getcustomersbycountry(string country_name)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_getcustomersbycountry_Result>("[northwindEntities].[fn_getcustomersbycountry](@country_name)", country_nameParameter);
        }
